...
public class MonkeyLearnClient {
    ...
    private static final String AUTH_TOKEN = "9e0401597d54393cf765b6b0e257c6f09f158762";
    ...
    public List<Set<String>> extract(List<String> articles) {
        ...
        ResponseHandler<List<Set<String>>> responseHandler = response -> {
            ...
            //put the entity of response values to ExtractResponseItem[];
            ...
            for (ExtractResponseItem result : results) {
                ...
                //Use a hashSet to record the three keywords from three extractions
    ...
    // A small example to help you understand how the MonkeyLearn API works
